...
import { CoreObj } from '@openrive/rive/document';
import { addFontAsset, addImageAsset, assetBytes, assetKind, assetUsers, fileAssets, guessMime, imageSizes, placeImage, removeAsset } from '@openrive/rive/assets';
...
import { ListRow } from '@openrive/ui';
            ...
            {list.map((a) => {
              ...
              return (
                <ListRow
                  ...
                  actions={
                    assetKind(a) === 'image' ? (
                      <button className="icon-btn" disabled={readOnly} title="Place on artboard" onClick={() => place(a)}>
                        <Plus size={13} />
                      </button>
                    ) : null
                  }
